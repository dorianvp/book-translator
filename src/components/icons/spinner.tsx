...
export function SpinnerIcon({ className }: HTMLAttributes<HTMLImageElement>) {
	return <svg className={className} width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
