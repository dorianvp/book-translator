...
export function SortableProduct({ product, changeHandler, k }: { product: Product, changeHandler: EventHandler<ChangeEvent>, k?: string | number } & HTMLProps<HTMLInputElement>) {
	const {
		attributes,
		listeners,
		setNodeRef,
